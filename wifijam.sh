...
function banner () {
	printf "${BD}
${GR}┊┊                  ${WH}╭━━━━━━
${GR}┊┊┊┊${YW}╭━╱▔▔▔╲━╮${GR}┊┊${YW}☼   ${WH}╭╯${RD}Sneh
${GR}┊╱╲┊${YW}╰▏▆┊┊┊▇▕╯${GR}╱╲┊   ${WH}┃${RD}Techie Sneh ${NT}${CY}v1.2${BD}
${GR}▔▔▔▔▔${YW}▏┊┊▇┊┊▕${GR}▔▔▔▔   ${WH}╰┳━━━━━━
${GR}┈${YW}╱▔▔╱┊┊━┻━┊┊╲▔▔╲  ${WH}━━╯${YW}
${GR}┈${YW}╲▂╱╭━━╮┊╭━━╮╲▂╱
...
function get_interface () {
	...
	echo -ne "\n${RD}4WSec${GR}@${RD}Sneh: ${WH}>> "; read iface
...
if [[ $attack == 1 ]]; then
	...
	printf "${NT}\n"
	nmcli dev wifi
	echo -ne "\n${RD}4WSec${GR}@${RD}Sneh: ${WH}>> "; read attck_ssid
	clear
	banner
	get_interface
	clear
	banner_2
	printf "                         ${WH}[ ${GR}Sneh ${WH}]\n"
	printf "              ${WH}===== ${RD}(◣_◢) @Techie Sneh (◣_◢) ${WH}=====\n\n"
